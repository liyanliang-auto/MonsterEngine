...
namespace MonsterRender::RHI::Vulkan {
    ...
    void VulkanDescriptorSet::_writeDescriptor(uint32 binding, VkDescriptorType type,
        ...
        MR_LOG(LogVulkanRHI, Verbose, "DEBUG: About to call vkUpdateDescriptorSets for binding %u, descriptorSet=0x%llx", 
               binding, (uint64)m_descriptorSet);
        
        vkUpdateDescriptorSets(m_device->getDevice(), 1, &write, 0, nullptr);
        
        MR_LOG(LogVulkanRHI, Verbose, "DEBUG: vkUpdateDescriptorSets completed for binding %u", binding);
    }
}
